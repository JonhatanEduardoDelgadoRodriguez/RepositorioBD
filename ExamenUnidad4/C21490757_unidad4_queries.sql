...
--Borramos la columna id_aulas ya que esta completamente en null y no se esta usando
--Al hacer el primer respaldo de esquemas,este se hara automaticamente,el querry es:-
--alter table horarios
--drop column id_aulas 
--y este nos mostrara que ya no esta la columna aula--
